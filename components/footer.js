    ...
    <div className="pt-12">
      ...
      <div className="pt-4 text-gray-800">
        ...
        <Link href="https://signup.drew.tech" passHref>
          <div className="umami--click--signup-button bg-green-900 mt-2 text-white cursor-pointer inline-flex px-10 leading-6 transition ease-in-out duration-150 shadow-sm font-semibold text-center justify-center uppercase py-4 border border-transparent items-center hover:bg-green-600  hover:border hover:border-green-900 rounded-md">
            Subscribe
          </div>
        </Link>
      </div>
